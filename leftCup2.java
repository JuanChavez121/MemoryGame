...
/**
 * Write a description of class leftCup2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class leftCup2 extends Actor
{
    /**
     * Act - do whatever the leftCup2 wants to do. This method is called whenever
    ...
    public leftCup2(easyTable world) {
        this.world = world;
    }
    public void act()
    {
