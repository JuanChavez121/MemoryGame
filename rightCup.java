...
/**
 * Write a description of class rightCup here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class rightCup extends Actor
{
    /**
     * Act - do whatever the rightCup wants to do. This method is called whenever
    ...
    public rightCup(easyTable world) {
        this.world = world; 
    }
    public void act(){
