 ...
 */
public class middleCup1 extends Actor
{
    ...
    public middleCup1(easyTable world) {
        this.world = world;
    }
    ...
    public void act()
    {
        if (getY() >= targetY)
        {
            ...
            ball1 ball2 = (ball1) getWorld().getObjects(ball1.class).get(0); 
            if (ball2 != null)
            {
        ...
        if (getWorld() instanceof mediumTable) {
            mediumTable world = (mediumTable) getWorld();
        ...
        if (getY() < targetY &&numSwaps!=0)
            ...
            if (Greenfoot.mouseClicked(this) && numSwaps == 0) {
                ...
                nextArrow1 arrow1 = new nextArrow1();
